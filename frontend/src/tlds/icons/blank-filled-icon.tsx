...
function BlankFilledIcon({ className, ...props }: React.ComponentProps<"svg">) {
  return (
    <svg
      data-slot="icon"
      ...
      {...props}
    >
      <path d="M9 5C10.1046 5 11 5.89543 11 7V9C11 10.1046 10.1046 11 9 11H7C5.89543 11 5 10.1046 5 9V7C5 5.89543 5.89543 5 7 5H9Z" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
