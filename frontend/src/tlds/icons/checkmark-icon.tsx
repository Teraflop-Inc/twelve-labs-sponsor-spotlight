...
function CheckmarkIcon({ className, ...props }: React.ComponentProps<"svg">) {
  return (
    <svg
      data-slot="icon"
      ...
      {...props}
    >
      <path d="M11.0996 5.48535L8.32715 10.4766C7.89108 11.2615 6.76862 11.2797 6.30664 10.5098L4.90039 8.16699L5.75781 7.65234L7.16406 9.99609C7.23009 10.1056 7.38975 10.1028 7.45215 9.99121L10.2256 5L11.0996 5.48535Z" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
